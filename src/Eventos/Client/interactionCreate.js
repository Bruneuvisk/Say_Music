  ...
  run: async (client, interaction) => {
    ...
    if (interaction.type === InteractionType.ApplicationCommand) {
      ...
      if (SlashCommands) {
        ...
        if (SlashCommands.memberperm.includes("Connect")) permissions.push(`\`Conectar\``)
        if (SlashCommands.memberperm.includes("Speak")) permissions.push(`\`Falar\``)
        if (SlashCommands.memberperm.includes("Stream")) permissions.push(`\`Transmitir Tela\``)
        ...
        if (SlashCommands.memberperm.includes("UseVAD")) permissions.push(`\`Usar Detecção de Voz\``)
        ...
        if (
          ...
          if (SlashCommands.clientperm.includes("AddReactions"))
            permissions.push(`\`Adicionar Reações\``)
          if (SlashCommands.clientperm.includes("Connect")) permissions.push(`\`Conectar\``)
          if (SlashCommands.clientperm.includes("Speak")) permissions.push(`\`Falar\``)
          if (SlashCommands.clientperm.includes("Stream")) permissions.push(`\`Transmitir Tela\``)
          ...
          if (SlashCommands.clientperm.includes("MoveMembers"))
            permissions.push(`\`Mover Membros\``)
          if (SlashCommands.clientperm.includes("UseVAD")) permissions.push(`\`Usar Detecção de Voz\``)
