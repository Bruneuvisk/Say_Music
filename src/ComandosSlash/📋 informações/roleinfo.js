...
module.exports = {
  ...
  options: [
    ...
    //{"Channel": { name: "qual_canal", description: "Qual canal deseja exibir informações no servidor?", required: true }}, //to use in the code: interacton.getChannel("what_channel")
    { Role: { name: 'qual_cargo', description: 'Qual cargo deseja exibir informações no servidor?', required: true } }, //to use in the code: interacton.getRole("what_role")
